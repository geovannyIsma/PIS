    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_asignaturas', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Cantidad de Asignaturas')),
            ],
            options={
                'verbose_name': 'Ciclo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desertores', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='Desertores')),
                ...
                ('asignatura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Prediccion.asignatura', verbose_name='Asignatura')),
